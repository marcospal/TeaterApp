...
DATABASES = {
    'default': {
        ...
        'NAME': '/home/tax/webapps/contabile2test/TeaterApp/sqlite.db',                      # Or path to database file if using sqlite3.
        # The following settings are not used with sqlite3:
        'USER': '',
        'PASSWORD': '',
        'HOST': '',                      # Empty for localhost through domain sockets or '127.0.0.1' for localhost through TCP.
...
TEMPLATE_DIRS = (
    '/home/tax/webapps/contabile2test/TeaterApp/teaterapp/templates/',
