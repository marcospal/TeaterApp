...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Profile.endLocation'
        db.add_column(u'show_profile', 'endLocation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['show.Location'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Location.show_opened'
        db.add_column(u'show_location', 'show_opened',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Profile.endLocation'
        db.delete_column(u'show_profile', 'endLocation_id')

        # Deleting field 'Location.show_opened'
        db.delete_column(u'show_location', 'show_opened')
    ...
    models = {
        ...
        u'show.location': {
            ...
            'show_opened': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
        ...
        u'show.profile': {
            ...
            'date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'endLocation': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['show.Location']", 'null': 'True', 'blank': 'True'}),
