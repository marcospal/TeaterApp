...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Location.directions'
        db.alter_column(u'show_location', 'directions', self.gf('django.db.models.fields.TextField')(max_length=256))

        # Changing field 'Question.text'
        db.alter_column(u'show_question', 'text', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Location.directions'
        db.alter_column(u'show_location', 'directions', self.gf('django.db.models.fields.CharField')(max_length=256))

        # Changing field 'Question.text'
        db.alter_column(u'show_question', 'text', self.gf('django.db.models.fields.CharField')(max_length=256))
    ...
    models = {
        ...
        u'show.location': {
            ...
            'directions': ('django.db.models.fields.TextField', [], {'max_length': '256'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
