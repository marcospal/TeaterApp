...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.year_of_birth'
        db.delete_column(u'show_profile', 'year_of_birth')

        # Adding field 'Profile.birth'
        db.add_column(u'show_profile', 'birth',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 10, 24, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Profile.year_of_birth'
        db.add_column(u'show_profile', 'year_of_birth',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Profile.birth'
        db.delete_column(u'show_profile', 'birth')
