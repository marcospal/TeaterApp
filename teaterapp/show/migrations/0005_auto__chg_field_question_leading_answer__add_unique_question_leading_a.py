...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.leading_answer'
        db.alter_column(u'show_question', 'leading_answer_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, null=True, to=orm['show.Answer']))
        # Adding unique constraint on 'Question', fields ['leading_answer']
        db.create_unique(u'show_question', ['leading_answer_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Question', fields ['leading_answer']
        db.delete_unique(u'show_question', ['leading_answer_id'])


        # Changing field 'Question.leading_answer'
        db.alter_column(u'show_question', 'leading_answer_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['show.Answer']))
