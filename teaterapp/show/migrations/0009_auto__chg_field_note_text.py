...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'show_note', 'text', self.gf('django.db.models.fields.TextField')(max_length=256))

    def backwards(self, orm):

        # Changing field 'Note.text'
        db.alter_column(u'show_note', 'text', self.gf('django.db.models.fields.CharField')(max_length=256))
