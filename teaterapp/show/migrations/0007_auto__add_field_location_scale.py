...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Location.scale'
        db.add_column(u'show_location', 'scale',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='locations', null=True, to=orm['show.Scale']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Location.scale'
        db.delete_column(u'show_location', 'scale_id')
